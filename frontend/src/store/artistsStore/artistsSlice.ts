...
export const artistsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      .addCase(createArtists.pending, (state) => {
    ...
    builder
      .addCase(deleteArtist.pending, (state, { meta: { arg: id } }) => {
    ...
    builder
      .addCase(toggleArtistPublic.pending, (state, { meta: { arg: id } }) => {
...
export const { selectArtists, selectArtistsFetching, selectArtistCreating, selectArtistDeleting, selectPublishArtist } =
